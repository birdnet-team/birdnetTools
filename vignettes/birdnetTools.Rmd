...
- Importing **multiple detection files** from separate audio recordings
- Importing a **single file** containing combined results
- Using detection results that are **already loaded** into R
